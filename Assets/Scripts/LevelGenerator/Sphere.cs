...
namespace LevelGenerator
{
    ...
    public class Sphere
    {
        ...
        private SphereGeneratorBuilder generatorBuilder;
        ...
        public void Generate(SphereGeneratorBuilder generator)
        {
            ...
            ClearSpheres();
            GeneratePositions();
            AssignMaterials(generatorBuilder._prefabSphere, generatorBuilder.transform);
        }
        ...
        {
            if (generatorBuilder._isStaticSize)
            {
                return generatorBuilder._sphereLocalScaleRadius;
            }
        ...
        public void GenerateFromJSON(SphereGeneratorBuilder generator, SphereJSON json, Material[] materials)
        {
            generatorBuilder = generator;
